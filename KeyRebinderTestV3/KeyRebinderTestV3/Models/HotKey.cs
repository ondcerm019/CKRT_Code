...
namespace KeyRebinderTestV3.Models
{
    ...
    {
        public static Dictionary<int, HotKey> DictHotKeyToCalBackProc;
        ...
        // ******************************************************************
        public bool Register(KeyModifier keyModifiers, Action<HotKey>? action)
        {
            var key = keyConverter.ConvertFromString(KeyString);
            ...
            int virtualKeyCode = KeyInterop.VirtualKeyFromKey((Key)key);
            ...
            //NotificationManager.ShowNotification(result.ToString() + ", " + Id + ", " + virtualKeyCode, "");
            return result;
        }
        ...
        {
            if (DictHotKeyToCalBackProc.TryGetValue(Id, out _))
            {
